...
describe "app" do
  ...
  describe "sessions api" do
    ...
    it "should render a list of all active sessions" do
      ...
      MultiJson.decode(last_response.body).should have_key("sessions")
      MultiJson.decode(last_response.body)["sessions"].length.should == 1
    end
    ...
    it "should render a list of all active sessions with timestamps" do
      ...
      get "/foospace/sessions"
      sess = MultiJson.decode(last_response.body)["sessions"].first
    ...
    it "should not render more than 100 sessions at once" do
      ...
      get "/foospace/sessions"
      MultiJson.decode(last_response.body).should have_key("sessions")
      MultiJson.decode(last_response.body)["sessions"].length.should == 100
    end
    ...
    it "should render sessions ordered by last_updated_at" do
      ...
      get "/foospace/sessions"
      sessions = MultiJson.decode(last_response.body)["sessions"]
  ...
  describe "events api: rendering events" do
    ...
    it "should render a list of all events" do
      ...
      get "/foospace/events"
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 1
    end
    ...
    it "should render a list of all events including event-times" do
      ...
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 1
      MultiJson.decode(last_response.body)["events"].first["_time"].to_i.should == @now-23
    end
    ...
    it "should render a list of all events including event-ids" do
      ...
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 1
      MultiJson.decode(last_response.body)["events"].first["_eid"].should == "sdkjgh9sd8f"
    end
    ...
    it "should render a list of all events including event-types" do
      ...
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 1
      MultiJson.decode(last_response.body)["events"].first["_type"].should == "foobar!!!"
    end
    ...
    it "should render a list of all events including _session-data" do
      ...
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 1
      MultiJson.decode(last_response.body)["events"].first["_session"].should == "blubb123"
    end
    ...
    it "should render a list of all events including _session-data" do
      ...
      MultiJson.decode(last_response.body)["events"].first["_session_key"].should == blubb123_md5
    end
    ...
    it "should render a list of all events in the correct chronological order" do
      ...
      get "/foospace/events"
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 3
      MultiJson.decode(last_response.body)["events"][0]["_eid"].should == "345345345"
      MultiJson.decode(last_response.body)["events"][1]["_eid"].should == "sdygsygsdg"
      MultiJson.decode(last_response.body)["events"][2]["_eid"].should == "daasdasd"
    end
    ...
    it "should not render more than 100 events at a time" do
      ...
      get "/foospace/events"
      MultiJson.decode(last_response.body).should have_key("events")
      MultiJson.decode(last_response.body)["events"].length.should == 100
    end
    ...
    it "should render all events since a time, not including events at that exact time" do
      ...
      MultiJson.decode(last_response.body)["events"].length.should == 2
      get "/foospace/events?since=#{@now-16}"
      MultiJson.decode(last_response.body)["events"].length.should == 1
      get "/foospace/events?since=#{@now-2}"
      MultiJson.decode(last_response.body)["events"].length.should == 0
    end
    ...
    it "should render all events for a single session key" do
      ...
      events = MultiJson.decode(last_response.body)["events"]
    ...
    it "should render a list of event types" do
      ...
      MultiJson.decode(last_response.body)["types"].length.should == 2
      MultiJson.decode(last_response.body)["types"].should include("fn0rd")
      MultiJson.decode(last_response.body)["types"].should include("f00bar")
    end
  ...
  describe "gauges api" do
    ...
    it "should return the right answer for: /metric/:name?at=timestamp" do
      ...
      MultiJson.decode(last_response.body).first.last.to_i.should == 23
    end
    ...
    it "should return the right answer for: /metric/:name?at=timestamp-timstamp" do
      ...
      MultiJson.decode(last_response.body).first.last.to_i.should == 18
    end

    it "should return the right answer for: /metric/:name?at=timestamp-timstamp" do
      get "/foospace/gauge/testgauge?at=1323691201-1323695205"
      MultiJson.decode(last_response.body).keys.length
    end

    it "should return the right answer for: /metric/:name?at=timestamp-timstamp" do
      get "/foospace/gauge/testgauge?at=1323691199-1323701201"
      MultiJson.decode(last_response.body).keys.length.should == 4
      MultiJson.decode(last_response.body)["1323687600"].to_i.should == 18
      MultiJson.decode(last_response.body)["1323691200"].to_i.should == 23
    end
    ...
    it "should return the right answer for: /metric/:name?at=timestamp-timstamp&sum=true" do
      ...
      MultiJson.decode(last_response.body).keys.length.should == 1
      MultiJson.decode(last_response.body)["sum"].to_i.should == 18+23
    end
  ...
  describe "three-dim gauges api" do
    ...
    it "should return the right answer for: /metric/:name?at=timestamp" do
      ...
      MultiJson.decode(last_response.body)["count"].to_i.should == 41
      MultiJson.decode(last_response.body)["values"].length.should == 2
      MultiJson.decode(last_response.body)["values"][0].should == ["uberfoo", "23"]
      MultiJson.decode(last_response.body)["values"][1].should == ["fnordyblubb", "18"]
    end
