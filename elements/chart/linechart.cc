...
namespace clip::elements::chart::linechart {
...
ReturnCode build(
  ...
  auto config_rc = expr_walk_map(expr_next(expr), {
    ...
    {"stroke-width", bind(&expr_rewritev, _1, "stroke-width", &geom_opts)},
    {"stroke-style", bind(&expr_rewritev, _1, "stroke-style", &geom_opts)},
    {"stroke-color", bind(&expr_rewritev, _1, "stroke-color", &geom_opts)},
    {"marker-size", bind(&expr_rewritev, _1, "marker-size", &geom_opts)},
    {"marker-shape", bind(&expr_rewritev, _1, "marker-shape", &geom_opts)},
    {"marker-color", bind(&expr_rewritev, _1, "marker-color", &geom_opts)},
